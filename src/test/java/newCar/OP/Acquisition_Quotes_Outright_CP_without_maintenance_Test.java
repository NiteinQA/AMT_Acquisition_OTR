...
public class Acquisition_Quotes_Outright_CP_without_maintenance_Test extends TestBase {
	...
	public void aquisition_quotes_outright_CP_OTR_calculation_without_maintenance_test(
	...
	@Test(priority = 2, dataProvider = "testData", dependsOnMethods = {
			"aquisition_quotes_outright_CP_OTR_calculation_without_maintenance_test" })

	public void aquisition_quotes_outright_CP_after_discount_calculations_without_maintenance_test(
			String manufacturer,                                     String model,
			String Vehicle_Basic_price,                              String road_tax_for_first_year,
			String percentage_cap_residual_value,                    String residual_value_used,
			String additional_terms,                                 String additional_mileage,
	...
	@Test(priority = 3, dataProvider = "testData", dependsOnMethods = {
			"aquisition_quotes_outright_CP_after_discount_calculations_without_maintenance_test" })

	public void aquisition_quotes_outright_CP_holding_cost_calculations_without_maintenance_test(
			String manufacturer,                                     String model,
			String Vehicle_Basic_price,                              String road_tax_for_first_year,
			String percentage_cap_residual_value,                    String residual_value_used,
			String additional_terms,                                 String additional_mileage,
		...
		boolean holding_cost_before_editing_percentage_value = obj_holding_cost
				.verify_holding_cost_before_editing_cap_values_without_maintenance(residual_value_used,
						percentage_cap_residual_value, maintenance_status, sheet_name);
		...
		boolean holding_cost_after_editing_additional_terms_and_mileage = obj_holding_cost
				.edit_additional_term_and_mileage_then_verify_holding_cost_without_maintenance(additional_terms,
	...
	@Test(priority = 4, dataProvider = "testData", dependsOnMethods = {
			"aquisition_quotes_outright_CP_holding_cost_calculations_without_maintenance_test" })

	public void aquisition_quotes_outright_CP_customer_quote_calculations_check_monthly_finance_payment_without_maintenance_test(
			String manufacturer,                                     String model,
			String Vehicle_Basic_price,                              String road_tax_for_first_year,
			String percentage_cap_residual_value,                    String residual_value_used,
			String additional_terms,                                 String additional_mileage,
		...
		boolean sales_discount_price_update_check = obj_customer_quote_page
				.update_sales_price_discount_and_verify_sales_price_vehicle_profit_monthly_rental_without_maintenance(
						driver, sheet_name);
	...
	@Test(priority = 5, dataProvider = "testData", dependsOnMethods = {
			"aquisition_quotes_outright_CP_customer_quote_calculations_check_monthly_finance_payment_without_maintenance_test" })

	public void aquisition_quotes_outright_CP_customer_quote_vehicle_profit_edit_check_without_maintenance_test(
			String manufacturer,                                     String model,
			String Vehicle_Basic_price,                              String road_tax_for_first_year,
			String percentage_cap_residual_value,                    String residual_value_used,
			String additional_terms,                                 String additional_mileage,
		...
		boolean monthly_total_payment_after_editing_vehicle_sales_price = obj_customer_quote_page
				.edit_otr_sales_price_and_check_monthly_total_payment_without_maintenance(sales_price_percentage,
						sheet_name);
	...
	@Test(priority = 6, dataProvider = "testData", dependsOnMethods = {
			"aquisition_quotes_outright_CP_customer_quote_vehicle_profit_edit_check_without_maintenance_test" })

	public void aquisition_quotes_outright_CP_customer_quote_part_exchange_value_edit_check_without_maintenance_test(
			String manufacturer,                                     String model,
			String Vehicle_Basic_price,                              String road_tax_for_first_year,
			String percentage_cap_residual_value,                    String residual_value_used,
			String additional_terms,                                 String additional_mileage,
    ...
    @Test(priority = 7, dataProvider = "testData", dependsOnMethods = { "aquisition_quotes_outright_CP_customer_quote_part_exchange_value_edit_check_without_maintenance_test" })
	...
	public void aquisition_quotes_outright_CP_quote_summary_values_verification_without_maintenance_test(
			String manufacturer,                                     String model,
			String Vehicle_Basic_price,                              String road_tax_for_first_year,
			String percentage_cap_residual_value,                    String residual_value_used,
			String additional_terms,                                 String additional_mileage,
