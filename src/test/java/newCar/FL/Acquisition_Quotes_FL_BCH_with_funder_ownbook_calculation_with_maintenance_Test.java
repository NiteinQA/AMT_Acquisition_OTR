...
public class Acquisition_Quotes_FL_BCH_with_funder_ownbook_calculation_with_maintenance_Test extends TestBase {
	...
	public void aquisition_quotes_FL_BCH_OTR_calculation_with_maintenance_test(String manufacturer, String model,
			...
			String percentageOfSaleProceedToCustomer, String secondaryHirePeriodRental,
	...
	@Test(priority = 2, dataProvider = "testData", dependsOnMethods = {
			"aquisition_quotes_FL_BCH_OTR_calculation_with_maintenance_test" })

	public void aquisition_quotes_FL_BCH_after_discount_calculations_with_maintenance_test(String manufacturer,
	...
	@Test(priority = 3, dataProvider = "testData", dependsOnMethods = {
			"aquisition_quotes_FL_BCH_after_discount_calculations_with_maintenance_test" })

	public void aquisition_quotes_FL_BCH_holding_cost_calculations_with_maintenance_test(String manufacturer,
			String model, String quoteRef, String expiryDate, String term, String milesPerAnnum,
			String monthlyFinanceRental, String monthlyMaintenanceRental, String finalBallonPayment, String documentFee,
			String pencePerExcessMileFinance, String pencePerExcessMileMaintenance,
			String percentageOfSaleProceedToCustomer, String secondaryHirePeriodRental,
		...
		boolean holding_cost_without_maintenance_boolean = obj_holding_cost_FL_BCH_page
				.verify_holding_cost_after_adding_funder_based_on_ownbook_calculation_with_maintenance(quoteRef,
						expiryDate, term, milesPerAnnum, monthlyFinanceRental, monthlyMaintenanceRental,
						finalBallonPayment, documentFee, pencePerExcessMileFinance, pencePerExcessMileMaintenance,
						percentageOfSaleProceedToCustomer, secondaryHirePeriodRental, sheet_name);
		Assert.assertTrue(holding_cost_without_maintenance_boolean);
	}

	@Test(priority = 4, dataProvider = "testData", dependsOnMethods = {
			"aquisition_quotes_FL_BCH_holding_cost_calculations_with_maintenance_test" })

	public void aquisition_quotes_FL_BCH_customer_quote_payment_profile_calculations_with_maintenance_test(String manufacturer,
			String model, String quoteRef, String expiryDate, String term, String milesPerAnnum,
			String monthlyFinanceRental, String monthlyMaintenanceRental, String finalBallonPayment, String documentFee,
			String pencePerExcessMileFinance, String pencePerExcessMileMaintenance,
			String percentageOfSaleProceedToCustomer, String secondaryHirePeriodRental,
		...
		boolean cust_quote_for_one_payment_boolean_status = obj_customer_quote_page
				.customer_Quote_FL_BCH_for_one_payment_option_with_maintenance_calculation(
...
//		.customer_Quote_FL_BCH_for_all_payment_option_with_maintenance_calculation(initial_payment, sheet_name);
//Assert.assertTrue(cust_quote_for_all_payment_boolean_status);

	}

	@Test(priority = 5, dataProvider = "testData", dependsOnMethods = {
			"aquisition_quotes_FL_BCH_customer_quote_payment_profile_calculations_with_maintenance_test" })

	public void aquisition_quotes_FL_BCH_quote_summary_values_verification_with_maintenance_test(String manufacturer,
			String model, String quoteRef, String expiryDate, String term, String milesPerAnnum,
			String monthlyFinanceRental, String monthlyMaintenanceRental, String finalBallonPayment, String documentFee,
			String pencePerExcessMileFinance, String pencePerExcessMileMaintenance,
			String percentageOfSaleProceedToCustomer, String secondaryHirePeriodRental,
...
//		Assert.assertTrue(value_check_after_Base_Int_change);
	...
	public Object[][] getTestData() throws IOException {
		Object[][] data = ReadExcelData.getTestData("FL_BCH_funder_withMaint_Ownbook");
		return data;
	}
