...
public class Acquisition_Quotes_FL_PCH_with_funder_ownbook_calculation_with_maintenance_Test extends TestBase {
	...
	public void aquisition_quotes_FL_PCH_customer_quote_payment_profile_calculations_with_maintenance_test(String manufacturer, String model,
		...
		boolean cust_quote_for_one_payment_boolean_status = obj_customer_quote_page
				.customer_Quote_FL_PCH_for_one_payment_option_with_maintenance_calculation(
...
//		Assert.assertTrue(value_check_after_maint_margin_change);
	...
	public Object[][] getTestData() throws IOException {
		Object[][] data = ReadExcelData.getTestData("FL_PCH_funder_withMaint_Ownbook");
		return data;
	}
