...
public class Acquisition_Quotes_FL_FL_with_funder_ownbook_calculation_with_maintenance_Test extends TestBase {
	...
	public void aquisition_quotes_FL_FL_OTR_calculation_with_maintenance_test(String manufacturer, String model,
	...
	@Test(priority = 2, dataProvider = "testData", dependsOnMethods = {
			"aquisition_quotes_FL_FL_OTR_calculation_with_maintenance_test" })

	public void aquisition_quotes_FL_FL_after_discount_calculations_with_maintenance_test(String manufacturer,
	...
	@Test(priority = 3, dataProvider = "testData", dependsOnMethods = {
			"aquisition_quotes_FL_FL_after_discount_calculations_with_maintenance_test" })

	public void aquisition_quotes_FL_FL_holding_cost_calculations_with_maintenance_test(String manufacturer,
			String model, String quoteRef, String expiryDate, String term, String milesPerAnnum,
			String monthlyFinanceRental, String monthlyMaintenanceRental, String finalBallonPayment, String documentFee,
			String pencePerExcessMileFinance, String pencePerExcessMileMaintenance,
			String percentageOfSaleProceedToCustomer, String secondaryHirePeriodRental,
	...
	@Test(priority = 4, dataProvider = "testData", dependsOnMethods = {
			"aquisition_quotes_FL_FL_holding_cost_calculations_with_maintenance_test" })

	public void aquisition_quotes_FL_FL_customer_quote_payment_profile_calculations_with_maintenance_test(String manufacturer,
			String model, String quoteRef, String expiryDate, String term, String milesPerAnnum,
			String monthlyFinanceRental, String monthlyMaintenanceRental, String finalBallonPayment, String documentFee,
			String pencePerExcessMileFinance, String pencePerExcessMileMaintenance,
			String percentageOfSaleProceedToCustomer, String secondaryHirePeriodRental,
		...
		boolean cust_quote_for_one_payment_boolean_status = obj_customer_quote_page
				.customer_Quote_FL_FL_for_one_payment_option_with_maintenance_calculation(
...
//Assert.assertTrue(cust_quote_for_all_payment_boolean_status);
	...
	@Test(priority = 5, dataProvider = "testData", dependsOnMethods = {
			"aquisition_quotes_FL_FL_customer_quote_payment_profile_calculations_with_maintenance_test" })

	public void aquisition_quotes_FL_FL_quote_summary_values_verification_with_maintenance_test(String manufacturer,
			String model, String quoteRef, String expiryDate, String term, String milesPerAnnum,
			String monthlyFinanceRental, String monthlyMaintenanceRental, String finalBallonPayment, String documentFee,
			String pencePerExcessMileFinance, String pencePerExcessMileMaintenance,
			String percentageOfSaleProceedToCustomer, String secondaryHirePeriodRental,
...
//Assert.assertTrue(balance_due_value1);
	...
	public Object[][] getTestData() throws IOException {
		Object[][] data = ReadExcelData.getTestData("FL_FL_funder_withMaint_Ownbook");
		return data;
	}
