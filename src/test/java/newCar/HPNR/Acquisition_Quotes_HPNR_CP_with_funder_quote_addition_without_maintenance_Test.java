...
public class Acquisition_Quotes_HPNR_CP_with_funder_quote_addition_without_maintenance_Test extends TestBase {
	...
	public void aquisition_quotes_HPNR_CP_customer_quote_calculations_check_monthly_finance_payment_without_maintenance_test(
			...
			String part_exchange_status,                              String target_rental,
			String matrix_credit_type,                                String balloon_payment_status,
			String referrer_commission,                     		  String sheet_name)throws InterruptedException, IOException, UnsupportedFlavorException, NumberFormatException, ClassNotFoundException {
	...
	"aquisition_quotes_HPNR_CP_customer_quote_calculations_check_monthly_finance_payment_without_maintenance_test" })
	...
	public Object[][] getTestData() throws IOException {
		Object[][] data = ReadExcelData.getTestData("HPNR_CP_funder_withoutMainten");
		return data;
	}
