...
public class Acquisition_Quotes_HPNR_CP_with_funder_quote_addition_with_maintenance_Test extends TestBase {
	...
	@Test(priority = 2, dataProvider = "testData", dependsOnMethods = {
			"aquisition_quotes_HPNR_CP_OTR_calculation_with_maintenance_test" })

	public void aquisition_quotes_HPNR_CP_after_discount_calculations_with_maintenance_test(
			String manufacturer,                     			String model, 
			String quoteRef,                                    String expiryDate,
			String term,                                        String milesPerAnnum,
			String cashDeposit,			                        String financeCharges, 
	...
	@Test(priority = 3, dataProvider = "testData", dependsOnMethods = {
			"aquisition_quotes_HPNR_CP_after_discount_calculations_with_maintenance_test" })

	public void aquisition_quotes_HPNR_CP_holding_cost_calculations_with_maintenance_test(
			String manufacturer,                     			String model, 
			String quoteRef,                                    String expiryDate,
			String term,                                        String milesPerAnnum,
			String cashDeposit,			                        String financeCharges, 
		...
		boolean holding_cost_with_maintenance_boolean = obj_holding_cost_HPNR_CP_page
	...
	@Test(priority = 4, dataProvider = "testData", dependsOnMethods = {
			"aquisition_quotes_HPNR_CP_holding_cost_calculations_with_maintenance_test" })

	public void aquisition_quotes_HPNR_CP_customer_quote_calculations_check_monthly_finance_payment_with_maintenance_test(
			String manufacturer,                     			String model, 
			String quoteRef,                                    String expiryDate,
			String term,                                        String milesPerAnnum,
			String cashDeposit,			                        String financeCharges, 
	...
	"aquisition_quotes_HPNR_CP_customer_quote_calculations_check_monthly_finance_payment_with_maintenance_test" })
	...
	public void aquisition_quotes_HPNR_CP_quote_summary_values_verification_with_maintenance_test(
			String manufacturer,                     			String model, 
			String quoteRef,                                    String expiryDate,
			String term,                                        String milesPerAnnum,
			String cashDeposit,			                        String financeCharges, 
			...
			String part_exchange_status,                        String target_rental,
			String matrix_credit_type,			                String balloon_payment_status,
			String referrer_commission,             			String sheet_name) throws Exception {
	...
	public Object[][] getTestData() throws IOException {
		Object[][] data = ReadExcelData.getTestData("HPNR_CP_funder_withMaintenanc");
		return data;
	}
