...
public class Acquisition_Quotes_HPNR_PCH_with_funder_quote_addition_with_maintenance_Test extends TestBase {
	...
	public void aquisition_quotes_HPNR_PCH_OTR_calculation_with_maintenance_test(String manufacturer, String model,
			...
			String order_deposit_from_excel, String document_fee_from_excel,  String security_deposit, String matrix_upsell, String referrer_upsell, String add_terms, String add_mileage, String maintenance_required,
	...
	public void aquisition_quotes_HPNR_PCH_customer_quote_payment_profile_calculations_with_maintenance_test(
		...
		boolean customer_quote_for_payment_boolean = obj_customer_quote_page
				.customer_Quote_HPNR_PCH_for_one_payment_option_for_funder_quote_addition_with_maintenance_calculation(
...
//		Assert.assertTrue(balance_due_value1);
	...
	public Object[][] getTestData() throws IOException {
		Object[][] data = ReadExcelData.getTestData("HPNR_PCH_funder_withMaintena");
		return data;
	}
