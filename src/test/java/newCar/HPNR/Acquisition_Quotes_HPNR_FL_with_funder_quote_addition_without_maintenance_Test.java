...
import com.amt.CustomerQuotePackage.CustomerQuotePage_HPNR_FL_Page;
import com.amt.HoldingCostPages.HoldingCost_HPNR_FL_Page;
import com.amt.QuoteSummaryPages.QuoteSummary_HPNR_FL_Page;
...
public class Acquisition_Quotes_HPNR_FL_with_funder_quote_addition_without_maintenance_Test extends TestBase {

	LoginPage obj_Login_Page;
	AcquisitionListingPage obj_acq_listing_page;
	VehicleSelectionPage obj_vehicle_selection_page;
	OptionsAccessoriesPage obj_options_accessories;
	ContractTypesAndOTR_HPNR_FL_Page obj_contract_types_and_OTR_page;
	HoldingCost_HPNR_FL_Page obj_holding_cost_HPNR_FL_page;
	CustomerQuotePage_HPNR_FL_Page obj_customer_quote_page;
	QuoteSummary_HPNR_FL_Page obj_quote_summary_page;

	@Test(priority = 1, dataProvider = "testData")
	public void aquisition_quotes_HPNR_FL_OTR_calculation_without_maintenance_test(String manufacturer, String model,
		...
		boolean subtotal_after_discount = obj_contract_types_and_OTR_page
				.contractTypes_and_OTR_selection_HPNR_FL_Ownbook_calculation(sheet_name);
		Assert.assertTrue(subtotal_after_discount);
	}

	@Test(priority = 2, dataProvider = "testData", dependsOnMethods = {
			"aquisition_quotes_HPNR_FL_OTR_calculation_without_maintenance_test" })

	public void aquisition_quotes_HPNR_FL_after_discount_calculations_without_maintenance_test(String manufacturer,
	...
	@Test(priority = 3, dataProvider = "testData", dependsOnMethods = {
			"aquisition_quotes_HPNR_FL_after_discount_calculations_without_maintenance_test" })

	public void aquisition_quotes_HPNR_FL_holding_cost_calculations_without_maintenance_test(String manufacturer,
			String model, String quoteRef, String expiryDate, String term, String milesPerAnnum, String cashDeposit,
			String financeCharges, String documentFee, String monthlyPayment, String finalBallonPayment,
			String optionToPurchaseFee, String actual_part_exchange_value_from_excel,
			String given_part_exchange_value_from_excel, String less_finance_settlement_from_excel,
		...
		boolean holding_cost_without_maintenance_boolean = obj_holding_cost_HPNR_FL_page
	...
	@Test(priority = 4, dataProvider = "testData", dependsOnMethods = {
			"aquisition_quotes_HPNR_FL_holding_cost_calculations_without_maintenance_test" })

	public void aquisition_quotes_HPNR_FL_customer_quote_payment_profile_calculations_without_maintenance_test(
		...
		boolean customer_quote_for_payment_boolean = obj_customer_quote_page
				.customer_Quote_HPNR_FL_for_one_payment_option_for_funder_quote_addition_without_maintenance_calculation(
		...
		boolean cutomer_quote_monthly_rental = obj_customer_quote_page
				.customer_Quote_HPNR_FL_for_all_payment_option_for_funder_quote_addition_without_maintenance_calculation(
	...
	@Test(priority = 5, dataProvider = "testData", dependsOnMethods = {
			"aquisition_quotes_HPNR_FL_customer_quote_payment_profile_calculations_without_maintenance_test" })

	public void aquisition_quotes_HPNR_FL_quote_summary_values_verification_without_maintenance_test(
			String manufacturer, String model, String quoteRef, String expiryDate, String term, String milesPerAnnum,
			String cashDeposit, String financeCharges, String documentFee, String monthlyPayment,
			String finalBallonPayment, String optionToPurchaseFee, String actual_part_exchange_value_from_excel,
			String given_part_exchange_value_from_excel, String less_finance_settlement_from_excel,
...
//		Assert.assertTrue(balance_due_value1);
	...
	public Object[][] getTestData() throws IOException {
		Object[][] data = ReadExcelData.getTestData("HPNR_FL_funder_withoutMaintena");
		return data;
	}
