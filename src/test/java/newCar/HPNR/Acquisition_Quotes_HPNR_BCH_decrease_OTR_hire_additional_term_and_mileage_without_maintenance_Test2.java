...
public class Acquisition_Quotes_HPNR_BCH_decrease_OTR_hire_additional_term_and_mileage_without_maintenance_Test2 extends TestBase {
	...
	public void aquisition_quotes_HPNR_BCH_verify_OTR_calculation_without_maintenance_test(String manufacturer, String model,
	...
	@Test(priority = 2, dataProvider = "testData", dependsOnMethods = {
			"aquisition_quotes_HPNR_BCH_verify_OTR_calculation_without_maintenance_test" })

	public void aquisition_quotes_HPNR_BCH_increase_OTR_without_maintenance_test(String manufacturer, String model,
			String vehicle_percentage_discount , String additional_discount_vehicle ,
            String options_percentage_discount , String additional_discount_options , 
            String paint_percentage_discount ,   String additional_discount_paint ,
            String rebate ,                      String marketing_bonus ,
		...
		obj_contract_types_and_OTR_page.decrease_OTR_price(on_road_price_for_invoice ,sheet_name );
	...
	@Test(priority = 3, dataProvider = "testData", dependsOnMethods = {
			"aquisition_quotes_HPNR_BCH_increase_OTR_without_maintenance_test" })
