...
public class Acquisition_Quotes_CP_PCH_with_funder_quote_addition_with_maintenance_Test extends TestBase {
	...
	public void aquisition_quotes_CP_PCH_OTR_calculation_with_maintenance_test(String manufacturer, String model,
			...
			String documentFee, String monthlyPayment, String monthlyMaintenancePayment, String optionalFinalPayment,
			String optionToPurchaseFee, String pencePerExcessMileFinance, String pencePerExcessMileMaintenance,
	...
	@Test(priority = 2, dataProvider = "testData", dependsOnMethods = {
			"aquisition_quotes_CP_PCH_OTR_calculation_with_maintenance_test" })

	public void aquisition_quotes_CP_PCH_after_discount_calculations_with_maintenance_test(String manufacturer,
	...
	@Test(priority = 3, dataProvider = "testData", dependsOnMethods = {
			"aquisition_quotes_CP_PCH_after_discount_calculations_with_maintenance_test" })

	public void aquisition_quotes_CP_PCH_holding_cost_calculations_with_maintenance_test(String manufacturer,
			String model, String quoteRef, String expiryDate, String term, String milesPerAnnum, String cashDeposit,
			String documentFee, String monthlyPayment, String monthlyMaintenancePayment, String optionalFinalPayment,
			String optionToPurchaseFee, String pencePerExcessMileFinance, String pencePerExcessMileMaintenance,
			String actual_part_exchange_value_from_excel, String given_part_exchange_value_from_excel,
		...
		boolean holding_cost_with_maintenance_boolean = obj_holding_cost_CP_PCH_page
				.verify_holding_cost_after_adding_funder_quote_with_maintenance(quoteRef, expiryDate, term,
						milesPerAnnum, cashDeposit, documentFee, monthlyPayment, monthlyMaintenancePayment,
						optionalFinalPayment, optionToPurchaseFee, pencePerExcessMileFinance,
	...
	@Test(priority = 4, dataProvider = "testData", dependsOnMethods = {
			"aquisition_quotes_CP_PCH_holding_cost_calculations_with_maintenance_test" })

	public void aquisition_quotes_CP_PCH_customer_quote_payment_profile_calculations_with_maintenance_test(
			String manufacturer, String model, String quoteRef, String expiryDate, String term, String milesPerAnnum,
			String cashDeposit, String documentFee, String monthlyPayment, String monthlyMaintenancePayment,
			String optionalFinalPayment, String optionToPurchaseFee, String pencePerExcessMileFinance,
			String pencePerExcessMileMaintenance, String actual_part_exchange_value_from_excel,
		...
		boolean customer_quote_for_payment_boolean = obj_customer_quote_page
				.customer_Quote_CP_PCH_for_one_payment_option_for_funder_quote_addition_with_maintenance_calculation(
		...
		boolean cutomer_quote_monthly_rental = obj_customer_quote_page
				.customer_Quote_CP_PCH_for_all_payment_option_for_funder_quote_addition_with_maintenance_calculation(
	...
	@Test(priority = 5, dataProvider = "testData", dependsOnMethods = {
			"aquisition_quotes_CP_PCH_customer_quote_payment_profile_calculations_with_maintenance_test" })

	public void aquisition_quotes_CP_PCH_quote_summary_values_verification_with_maintenance_test(String manufacturer,
			String model, String quoteRef, String expiryDate, String term, String milesPerAnnum, String cashDeposit,
			String documentFee, String monthlyPayment, String monthlyMaintenancePayment, String optionalFinalPayment,
			String optionToPurchaseFee, String pencePerExcessMileFinance, String pencePerExcessMileMaintenance,
			String actual_part_exchange_value_from_excel, String given_part_exchange_value_from_excel,
...
//		Assert.assertTrue(balance_due_value1);
	...
	public Object[][] getTestData() throws IOException {
		Object[][] data = ReadExcelData.getTestData("CP_PCH_funder_withMaintena");
		return data;
	}
