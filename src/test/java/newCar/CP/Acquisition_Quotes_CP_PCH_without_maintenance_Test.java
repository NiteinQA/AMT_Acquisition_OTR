...
public class Acquisition_Quotes_CP_PCH_without_maintenance_Test extends TestBase {
	...
	public void aquisition_quotes_CP_PCH_holding_cost_calculations_without_maintenance_test(String manufacturer, String model,
		...
		obj_holding_cost_page = new HoldingCost_CP_PCH_Page();
	...
	public void aquisition_quotes_CP_PCH_customer_quote_payment_profile_calculations_without_maintenance_test(String manufacturer, String model,
		...
		boolean customer_quote_for_payment_boolean = obj_customer_quote_page
				.customer_Quote_CP_PCH_for_one_payment_option_without_maintenance_calculation(
		...
		boolean cutomer_quote_monthly_rental = obj_customer_quote_page
				.customer_Quote_CP_PCH_for_all_payment_option_without_maintenance_calculation(initial_payment,sheet_name);
	...
	public Object[][] getTestData() throws IOException {
		Object[][] data = ReadExcelData.getTestData("CP_PCH_withoutMaintenance");
		return data;
	}
