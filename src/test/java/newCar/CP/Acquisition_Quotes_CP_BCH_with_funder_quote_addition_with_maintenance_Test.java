...
public class Acquisition_Quotes_CP_BCH_with_funder_quote_addition_with_maintenance_Test extends TestBase {
	...
	public void aquisition_quotes_CP_BCH_holding_cost_calculations_with_maintenance_test(String manufacturer, String model,
		...
		boolean holding_cost_with_maintenance_boolean = obj_holding_cost_CP_BCH_page
				.verify_holding_cost_after_adding_funder_quote_with_maintenance( quoteRef,  expiryDate , term, milesPerAnnum, cashDeposit,
						 documentFee,  monthlyPayment ,  monthlyMaintenancePayment ,  optionalFinalPayment ,  optionToPurchaseFee,  pencePerExcessMileFinance ,  pencePerExcessMileMaintenance ,  sheet_name);
	...
	public void aquisition_quotes_CP_BCH_customer_quote_payment_profile_calculations_with_maintenance_test(String manufacturer, String model,
		...
		boolean customer_quote_for_payment_boolean = obj_customer_quote_page
				.customer_Quote_CP_BCH_for_one_payment_option_for_funder_quote_addition_with_maintenance_calculation(
...
System.out.println("");
		...
		boolean cutomer_quote_monthly_rental = obj_customer_quote_page
				.customer_Quote_CP_BCH_for_all_payment_option_for_funder_quote_addition_with_maintenance_calculation(initial_payment,sheet_name);
...
//		Assert.assertTrue(balance_due_value1);
	...
	public Object[][] getTestData() throws IOException {
		Object[][] data = ReadExcelData.getTestData("CP_BCH_funder_withMaintena");
		return data;
	}
