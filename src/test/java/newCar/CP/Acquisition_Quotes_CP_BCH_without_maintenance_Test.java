...
public class Acquisition_Quotes_CP_BCH_without_maintenance_Test extends TestBase {
	...
	public void aquisition_quotes_CP_BCH_customer_quote_payment_profile_calculations_without_maintenance_test(String manufacturer, String model,
		...
		boolean customer_quote_for_payment_boolean = obj_customer_quote_page
				.customer_Quote_CP_BCH_for_one_payment_option_without_maintenance_calculation(
	...
	public Object[][] getTestData() throws IOException {
		Object[][] data = ReadExcelData.getTestData("CP_BCH_withoutMaintenance");
		return data;
	}
