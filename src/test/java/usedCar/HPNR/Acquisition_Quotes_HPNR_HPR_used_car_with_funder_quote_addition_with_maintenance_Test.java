...
public class Acquisition_Quotes_HPNR_HPR_used_car_with_funder_quote_addition_with_maintenance_Test extends TestBase {
...
//Assert.assertTrue(cost_price_ex_vat_and_options_and_preparation_cost);
    ...
    @Test(priority = 8, dataProvider = "testData", dependsOnMethods = {"aquisition_quotes_customer_quote_monthly_total_payment_after_balloon_payment_off_with_maintenance_test"})

    public void aquisition_quotes_verify_customer_quote_monthly_finance_payment_after_adding_referrer_commission_test(String registrationNumber, String mileage, String vehicelCostPrice, String options_and_preparation_cost,
			String quoteRef, String expiryDate, String term, String milesPerAnnum, String cashDeposit,
			String financeCharges, String documentFee, String monthlyPayment, String finalBallonPayment,
			String optionToPurchaseFee, String actual_part_exchange_value_from_excel,
			String given_part_exchange_value_from_excel, String less_finance_settlement_from_excel,
	...
	public Object[][] getTestData() throws IOException {
		Object[][] data = ReadExcelData.getTestData("HPNR_HPR_funder_Maint_used_car");
		return data;
	}
