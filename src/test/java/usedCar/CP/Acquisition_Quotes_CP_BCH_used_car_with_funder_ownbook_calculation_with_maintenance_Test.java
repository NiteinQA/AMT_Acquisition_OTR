...
public class Acquisition_Quotes_CP_BCH_used_car_with_funder_ownbook_calculation_with_maintenance_Test extends TestBase {
	...
	public void aquisition_quotes_used_car_OTR_calculation_with_maintenance_test(String registrationNumber,
			...
			String expiryDate, String term, String milesPerAnnum, String cashDeposit, String documentFee,
			String monthlyPayment, String monthlyMaintenancePayment, String optionalFinalPayment,
	...
	public void aquisition_quotes_holding_cost_calculations_with_maintenance_test(String registrationNumber,
		...
		boolean holding_cost_with_maintenance_boolean = obj_holding_cost_CP_BCH_page
				.verify_holding_cost_after_adding_funder_based_on_ownbook_calculation_with_maintenance(quoteRef,
						expiryDate, term, milesPerAnnum, cashDeposit, documentFee, monthlyPayment, optionalFinalPayment,
...
// Assert.assertTrue(value_check_after_Finance_margin_change);
	...
	public Object[][] getTestData() throws IOException {
		Object[][] data = ReadExcelData.getTestData("CP_BCH_fun_Maint_UC_Ownbook");
		return data;
	}
