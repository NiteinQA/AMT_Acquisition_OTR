...
public class Acquisition_Quotes_CP_PCH_used_car_with_funder_quote_addition_without_maintenance_Test extends TestBase {
...
//		Assert.assertTrue(cutomer_quote_monthly_rental);
	...
	public Object[][] getTestData() throws IOException {
		Object[][] data = ReadExcelData.getTestData("CP_PCH_fund-wo-Maint_used_car");
		return data;
	}
