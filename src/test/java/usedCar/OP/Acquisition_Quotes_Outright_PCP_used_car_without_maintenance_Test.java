...
public class Acquisition_Quotes_Outright_PCP_used_car_without_maintenance_Test extends TestBase {
...
//		Assert.assertTrue(holding_cost_after_editing_additional_terms_and_mileage);
	...
	public Object[][] getTestData() throws IOException {
		Object[][] data = ReadExcelData.getTestData("OP_PCP_w-oMaint_used_car");
		return data;
	}
