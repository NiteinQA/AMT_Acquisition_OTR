...
public class Acquisition_Quotes_Outright_HPR_used_car_with_maintenance_Test extends TestBase {
	...
	public void aquisition_quotes_customer_quote_monthly_finance_payment_after_balloon_payment_off_with_maintenance_test(String registrationNumber,
			String mileage, String vehicelCostPrice, String options_and_preparation_cost,
			String Vehicle_Basic_price, String road_tax_for_first_year, String percentage_cap_residual_value,
			String percentage_cap_maint_value, String residual_value_used, String maint_cost_used, String target_rental,
			String additional_terms, String additional_mileage, String vehicle_profit, String sales_price_percentage, String maintenance_status,
    ...
    @Test(priority =6 , dataProvider = "testData", dependsOnMethods = {"aquisition_quotes_customer_quote_monthly_finance_payment_after_balloon_payment_off_with_maintenance_test"})
	...
	public Object[][] getTestData() throws IOException {
		Object[][] data = ReadExcelData.getTestData("OP_HPR_Maint_used_car");
		return data;
	}
