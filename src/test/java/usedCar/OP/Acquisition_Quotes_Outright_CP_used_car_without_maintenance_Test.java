...
public class Acquisition_Quotes_Outright_CP_used_car_without_maintenance_Test extends TestBase {
	...
	public Object[][] getTestData() throws IOException {
		Object[][] data = ReadExcelData.getTestData("OP_CP_w-oMaint_used_car");
		return data;
	}
