...
public class Acquisition_Quotes_FL_FL_used_car_with_funder_ownbook_calculation_with_maintenance_Test extends TestBase {
	...
	public void aquisition_quotes_used_car_OTR_calculation_with_maintenance_test(String registrationNumber,
			...
			String expiryDate, String term, String milesPerAnnum, String monthlyFinanceRental,
...
// Assert.assertTrue(value_check_after_Finance_margin_change);
	...
	public Object[][] getTestData() throws IOException {
		Object[][] data = ReadExcelData.getTestData("FL_FL_fun_Maint_UC_Ownbook");
		return data;
	}
