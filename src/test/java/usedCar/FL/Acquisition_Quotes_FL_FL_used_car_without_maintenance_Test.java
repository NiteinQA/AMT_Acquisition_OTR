...
public class Acquisition_Quotes_FL_FL_used_car_without_maintenance_Test extends TestBase {
...
//		Assert.assertTrue(balance_due_value1);
	...
	public Object[][] getTestData() throws IOException {
		Object[][] data = ReadExcelData.getTestData("FL_FL_withoutMaint_used_car");
		return data;
	}
