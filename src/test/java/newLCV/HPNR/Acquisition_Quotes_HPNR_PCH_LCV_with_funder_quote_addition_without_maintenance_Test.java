...
public class Acquisition_Quotes_HPNR_PCH_LCV_with_funder_quote_addition_without_maintenance_Test extends TestBase {
	...
	public void aquisition_quotes_HPNR_PCH_customer_quote_payment_profile_calculations_without_maintenance_test(
		...
		boolean customer_quote_for_payment_boolean = obj_customer_quote_page
				.customer_Quote_HPNR_PCH_for_one_payment_option_for_funder_quote_addition_without_maintenance_calculation(
...
//				.customer_Quote_HPNR_PCH_for_all_payment_option_for_funder_quote_addition_without_maintenance_calculation(
...
//		Assert.assertTrue(cutomer_quote_monthly_rental);
	...
	public Object[][] getTestData() throws IOException {
		Object[][] data = ReadExcelData.getTestData("HPNR_PCH_fund_woMaint_LCV");
		return data;
	}
