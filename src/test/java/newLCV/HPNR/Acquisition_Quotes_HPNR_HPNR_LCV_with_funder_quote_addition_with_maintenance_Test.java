...
public class Acquisition_Quotes_HPNR_HPNR_LCV_with_funder_quote_addition_with_maintenance_Test extends TestBase {
    ...
    @Test(priority =8 , dataProvider = "testData", dependsOnMethods = {"aquisition_quotes_HPNR_HPNR_customer_quote_monthly_total_payment_after_balloon_payment_off_with_maintenance_test"})
	...
	public Object[][] getTestData() throws IOException {
		Object[][] data = ReadExcelData.getTestData("HPNR_HPNR_fundMaint_LCV");
		return data;
	}
