...
public class Acquisition_Quotes_HPNR_PCP_LCV_with_maintenance_Test extends TestBase {
	...
	HoldingCost_HPNR_PCP_Page obj_holding_cost_page;
	CustomerQuotePage_HPNR_HPRPage obj_customer_quote_page;
	QuoteSummary_HPNR_PCP_Page obj_quote_summary_page;


	@Test(priority = 1, dataProvider = "testData")
	public void aquisition_quotes_HPNR_PCP_OTR_calculation_with_maintenance_test(
	...
	@Test(priority=2, dataProvider="testData", dependsOnMethods = { "aquisition_quotes_HPNR_PCP_OTR_calculation_with_maintenance_test" })

	public void aquisition_quotes_HPNR_PCP_after_discount_calculations_with_maintenance_test(
			String manufacturer,                                     String model,
			String Vehicle_Basic_price,                              String road_tax_for_first_year,
			String percentage_cap_residual_value,                    String percentage_cap_maint_value,
			String residual_value_used,                              String maint_cost_used,
	...
	@Test(priority=3, dataProvider="testData", dependsOnMethods = { "aquisition_quotes_HPNR_PCP_after_discount_calculations_with_maintenance_test" })

	public void aquisition_quotes_HPNR_PCP_holding_cost_calculations_with_maintenance_test(
			String manufacturer,                                     String model,
			String Vehicle_Basic_price,                              String road_tax_for_first_year,
			String percentage_cap_residual_value,                    String percentage_cap_maint_value,
			String residual_value_used,                              String maint_cost_used,
	...
	@Test(priority=4, dataProvider="testData", dependsOnMethods = { "aquisition_quotes_HPNR_PCP_holding_cost_calculations_with_maintenance_test" })

	public void aquisition_quotes_HPNR_PCP_customer_quote_calculations_check_monthly_finance_payment_with_maintenance_test(
			String manufacturer,                                     String model,
			String Vehicle_Basic_price,                              String road_tax_for_first_year,
			String percentage_cap_residual_value,                    String percentage_cap_maint_value,
			String residual_value_used,                              String maint_cost_used,
	...
	@Test(priority=5, dataProvider="testData", dependsOnMethods = { "aquisition_quotes_HPNR_PCP_customer_quote_calculations_check_monthly_finance_payment_with_maintenance_test" })

	public void aquisition_quotes_HPNR_PCP_customer_quote_vehicle_profit_edit_check_with_maintenance_test(
			String manufacturer,                                     String model,
			String Vehicle_Basic_price,                              String road_tax_for_first_year,
			String percentage_cap_residual_value,                    String percentage_cap_maint_value,
			String residual_value_used,                              String maint_cost_used,
	...
	@Test(priority=6, dataProvider="testData", dependsOnMethods = { "aquisition_quotes_HPNR_PCP_customer_quote_vehicle_profit_edit_check_with_maintenance_test" })

	public void aquisition_quotes_HPNR_PCP_customer_quote_part_exchange_value_edit_check_with_maintenance_test(
			String manufacturer,                                     String model,
			String Vehicle_Basic_price,                              String road_tax_for_first_year,
			String percentage_cap_residual_value,                    String percentage_cap_maint_value,
			String residual_value_used,                              String maint_cost_used,
    ...
    @Test(priority =7 , dataProvider = "testData", dependsOnMethods = {"aquisition_quotes_HPNR_PCP_customer_quote_part_exchange_value_edit_check_with_maintenance_test"})
	...
	public void aquisition_quotes_HPNR_PCP_quote_summary_values_verification_with_maintenance_test(
			String manufacturer,                                     String model,
			String Vehicle_Basic_price,                              String road_tax_for_first_year,
			String percentage_cap_residual_value,                    String percentage_cap_maint_value,
			String residual_value_used,                              String maint_cost_used,
	...
	public Object[][] getTestData() throws IOException {
		Object[][] data = ReadExcelData.getTestData("HPNR_PCP_withMaint_LCV");
		return data;
	}
