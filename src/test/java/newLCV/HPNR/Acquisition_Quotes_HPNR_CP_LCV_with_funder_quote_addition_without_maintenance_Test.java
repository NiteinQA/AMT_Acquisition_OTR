...
import com.amt.CustomerQuotePackage.CustomerQuotePage_HPNR_CP_Page;
...
public class Acquisition_Quotes_HPNR_CP_LCV_with_funder_quote_addition_without_maintenance_Test extends TestBase {
	...
	HoldingCost_HPNR_CP_Page obj_holding_cost_HPNR_CP_page;
	CustomerQuotePage_HPNR_CP_Page obj_customer_quote_page;
	...
	@Test(priority = 2, dataProvider = "testData", dependsOnMethods = {
			"aquisition_quotes_HPNR_CP_OTR_calculation_without_maintenance_test" })
	...
	@Test(priority = 3, dataProvider = "testData", dependsOnMethods = {
			"aquisition_quotes_HPNR_CP_after_discount_calculations_without_maintenance_test" })
	...
	public void aquisition_quotes_HPNR_CP_holding_cost_calculations_without_maintenance_test(String manufacturer, String model,
		...
		obj_holding_cost_HPNR_CP_page = new HoldingCost_HPNR_CP_Page();

		boolean holding_cost_without_maintenance_boolean = obj_holding_cost_HPNR_CP_page
	...
	@Test(priority = 4, dataProvider = "testData", dependsOnMethods = {
			"aquisition_quotes_HPNR_CP_holding_cost_calculations_without_maintenance_test" })
	...
	Assert.assertTrue(monthlyFinancePaymentCheckAfterReferrerCommission);
		  ...
		  @Test(priority = 6, dataProvider = "testData", dependsOnMethods = { "aquisition_quotes_HPNR_CP_customer_quote_calculations_check_monthly_finance_payment_without_maintenance_test"
				  })
		  ...
		  (String manufacturer, String model,
					...
					String order_deposit_from_excel, String finance_deposit, String document_fee_from_excel, String upsell,
					String maintenance_required, String maintenance_margin, String initial_payment, String part_exchange_status,
					String target_rental, String matrix_credit_type, String balloon_payment_status, String referrer_commission, String sheet_name) throws
	...
	public Object[][] getTestData() throws IOException {
		Object[][] data = ReadExcelData.getTestData("HPNR_CP_funder_woMaint_LCV");
		return data;
	}
