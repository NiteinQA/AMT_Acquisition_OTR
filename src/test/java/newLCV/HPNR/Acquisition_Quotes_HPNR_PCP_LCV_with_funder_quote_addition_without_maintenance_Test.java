...
public class Acquisition_Quotes_HPNR_PCP_LCV_with_funder_quote_addition_without_maintenance_Test extends TestBase {
	...
	@Test(priority = 2, dataProvider = "testData", dependsOnMethods = {
			"aquisition_quotes_HPNR_PCP_OTR_calculation_without_maintenance_test" })
	...
	@Test(priority = 3, dataProvider = "testData", dependsOnMethods = {
			"aquisition_quotes_HPNR_PCP_after_discount_calculations_without_maintenance_test" })
	...
	@Test(priority = 4, dataProvider = "testData", dependsOnMethods = {
			"aquisition_quotes_HPNR_PCP_holding_cost_calculations_without_maintenance_test" })
	...
	public Object[][] getTestData() throws IOException {
		Object[][] data = ReadExcelData.getTestData("HPNR_PCP_funder_woMaint_LCV");
		return data;
	}
