...
public class Acquisition_Quotes_HPNR_FL_LCV_with_maintenance_Test extends TestBase {
	...
	public void aquisition_quotes_HPNR_FL_OTR_calculation_with_maintenance_test(String manufacturer, String model,
	...
	@Test(priority = 2, dataProvider = "testData", dependsOnMethods = {
			"aquisition_quotes_HPNR_FL_OTR_calculation_with_maintenance_test" })

	public void aquisition_quotes_HPNR_FL_after_discount_calculations_with_maintenance_test(String manufacturer,
	...
	@Test(priority = 3, dataProvider = "testData", dependsOnMethods = {
			"aquisition_quotes_HPNR_FL_after_discount_calculations_with_maintenance_test" })

	public void aquisition_quotes_HPNR_FL_other_support_check_with_maintenance_test(String manufacturer, String model,
			String road_tax_for_first_year, String on_road_price_for_invoice, String other_support_value,
			String percentage_cap_residual_value_used, String percentage_cap_maintenance_cost_used,
			String residual_value_used, String main_cost_used, String actual_part_exchange_value_from_excel,
			String given_part_exchange_value_from_excel, String less_finance_settlement_from_excel,
	...
	@Test(priority = 4, dataProvider = "testData", dependsOnMethods = {
			"aquisition_quotes_HPNR_FL_other_support_check_with_maintenance_test" })

	public void aquisition_quotes_HPNR_FL_holding_cost_calculations_with_maintenance_test(String manufacturer,
			String model, String road_tax_for_first_year, String on_road_price_for_invoice, String other_support_value,
			String percentage_cap_residual_value_used, String percentage_cap_maintenance_cost_used,
			String residual_value_used, String main_cost_used, String actual_part_exchange_value_from_excel,
			String given_part_exchange_value_from_excel, String less_finance_settlement_from_excel,
	...
	@Test(priority = 5, dataProvider = "testData", dependsOnMethods = {
			"aquisition_quotes_HPNR_FL_holding_cost_calculations_with_maintenance_test" })

	public void aquisition_quotes_HPNR_FL_customer_quote_payment_profile_calculations_with_maintenance_test(
		...
		boolean cust_quote_for_one_payment_boolean_status = obj_customer_quote_page
				.customer_Quote_HPNR_FL_for_one_payment_option_with_maintenance_calculation(
...
//		Assert.assertTrue(cust_quote_for_all_payment_boolean_status);
	...
	public void aquisition_quotes_HPNR_FL_quote_summary_values_verification_with_maintenance_test(String manufacturer,
			String model, String road_tax_for_first_year, String on_road_price_for_invoice, String other_support_value,
			String percentage_cap_residual_value_used, String percentage_cap_maintenance_cost_used,
			String residual_value_used, String main_cost_used, String actual_part_exchange_value_from_excel,
			String given_part_exchange_value_from_excel, String less_finance_settlement_from_excel,
...
//		//Assert.assertTrue(value_check_after_maint_margin_change);
	...
	public Object[][] getTestData() throws IOException {
		Object[][] data = ReadExcelData.getTestData("HPNR_FL_withMaintLCV");
		return data;
	}
