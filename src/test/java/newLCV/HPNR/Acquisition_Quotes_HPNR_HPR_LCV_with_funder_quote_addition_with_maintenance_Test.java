...
public class Acquisition_Quotes_HPNR_HPR_LCV_with_funder_quote_addition_with_maintenance_Test extends TestBase {
	...
	public void aquisition_quotes_HPNR_HPR_holding_cost_calculations_with_maintenance_test(
		...
		boolean holding_cost_with_maintenance_boolean = obj_holding_cost_HPNR_HPR_page
	...
	public void aquisition_quotes_HPNR_HPR_customer_quote_monthly_total_payment_after_balloon_payment_off_with_maintenance_test(
			String manufacturer,                                      String model,
			String quoteRef,                                          String expiryDate,
			String term,                                              String milesPerAnnum,
			String cashDeposit,                                       String financeCharges,
    ...
    @Test(priority = 8, dataProvider = "testData", dependsOnMethods = {"aquisition_quotes_HPNR_HPR_customer_quote_monthly_total_payment_after_balloon_payment_off_with_maintenance_test"})
	...
	public Object[][] getTestData() throws IOException {
		Object[][] data = ReadExcelData.getTestData("HPNR_HPR_fund_Maint_LCV");
		return data;
	}
