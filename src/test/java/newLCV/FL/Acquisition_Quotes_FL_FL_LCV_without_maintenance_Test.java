...
public class Acquisition_Quotes_FL_FL_LCV_without_maintenance_Test extends TestBase {
	...
	public void aquisition_quotes_FL_FL_OTR_calculation_without_maintenance_test(String manufacturer, String model,
			...
			String residual_value_used, String actual_part_exchange_value_from_excel,
	...
	@Test(priority = 2, dataProvider = "testData", dependsOnMethods = {
			"aquisition_quotes_FL_FL_OTR_calculation_without_maintenance_test" })

	public void aquisition_quotes_FL_FL_after_discount_calculations_without_maintenance_test(String manufacturer,
	...
	@Test(priority = 3, dataProvider = "testData", dependsOnMethods = {
			"aquisition_quotes_FL_FL_after_discount_calculations_without_maintenance_test" })

	public void aquisition_quotes_FL_FL_holding_cost_calculations_without_maintenance_test(String manufacturer,
			String model, String vehicle_Basic_Price, String road_tax_for_first_year,
			String percentage_cap_residual_value_used, String residual_value_used,
			String actual_part_exchange_value_from_excel, String given_part_exchange_value_from_excel,
			String less_finance_settlement_from_excel, String order_deposit_from_excel, String document_fee_from_excel,
	...
	@Test(priority = 4, dataProvider = "testData", dependsOnMethods = {
			"aquisition_quotes_FL_FL_holding_cost_calculations_without_maintenance_test" })

	public void aquisition_quotes_FL_FL_customer_quote_payment_profile_calculations_without_maintenance_test(
...
//				.customer_Quote_FL_FL_for_all_payment_option_without_maintenance_calculation(initial_payment,
//						sheet_name);
//		Assert.assertTrue(cutomer_quote_monthly_rental);
	}

	@Test(priority = 5, dataProvider = "testData", dependsOnMethods = {
			"aquisition_quotes_FL_FL_customer_quote_payment_profile_calculations_without_maintenance_test" })

	public void aquisition_quotes_FL_FL_quote_summary_values_verification_without_maintenance_test(String manufacturer,
			String model, String vehicle_Basic_Price, String road_tax_for_first_year,
			String percentage_cap_residual_value_used, String residual_value_used,
			String actual_part_exchange_value_from_excel, String given_part_exchange_value_from_excel,
			String less_finance_settlement_from_excel, String order_deposit_from_excel, String document_fee_from_excel,
...
//		Assert.assertTrue(balance_due_value1);
	...
	public Object[][] getTestData() throws IOException {
		Object[][] data = ReadExcelData.getTestData("FL_FLwoMaint_LCV");
		return data;
	}
