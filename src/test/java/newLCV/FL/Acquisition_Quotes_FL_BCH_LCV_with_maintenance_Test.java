...
import com.amt.pages.ContractTypesAndOTRPages.ContractTypesAndOTR_FL_BCH_OTR_CalculationPage;
import com.amt.testBase.TestBase;
import com.amt.testUtil.ReadExcelData;

@Listeners(com.amt.testUtil.ScreenshotListener.class)
public class Acquisition_Quotes_FL_BCH_LCV_with_maintenance_Test extends TestBase {
	...
	public void aquisition_quotes_FL_BCH_OTR_calculation_with_maintenance_test(String manufacturer, String model,
		...
		obj_contract_types_and_OTR_page = new ContractTypesAndOTR_FL_BCH_OTR_CalculationPage();
		...
		boolean subtotal_after_discount = obj_contract_types_and_OTR_page
				.contractTypes_and_OTR_selection_FL_BCH_Ownbook_calculation(sheet_name);
	...
	public void aquisition_quotes_FL_BCH_after_discount_calculations_with_maintenance_test(String manufacturer,
			String model, String road_tax_for_first_year, String on_road_price_for_invoice,
	...
	public void aquisition_quotes_FL_BCH_customer_quote_payment_profile_calculations_with_maintenance_test(
...
//		Assert.assertTrue(balance_due_value1);
	...
	public Object[][] getTestData() throws IOException {
		Object[][] data = ReadExcelData.getTestData("FL_BCHwithMaint_LCV");
		return data;
	}
