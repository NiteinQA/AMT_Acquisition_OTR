...
public class Acquisition_Quotes_FL_FL_LCV_with_maintenance_Test extends TestBase {
	...
	HoldingCost_FL_FLPage obj_holding_cost_page;
	...
	public void aquisition_quotes_FL_FL_holding_cost_calculations_with_maintenance_test(String manufacturer,
		...
		obj_holding_cost_page = new HoldingCost_FL_FLPage();
...
//		Assert.assertTrue(balance_due_value1);
	...
	public Object[][] getTestData() throws IOException {
		Object[][] data = ReadExcelData.getTestData("FL_FLwithMaint_LCV");
		return data;
	}
