...
public class Acquisition_Quotes_CP_BCH_LCV_with_funder_quote_addition_without_maintenance_Test extends TestBase {
...
//		Assert.assertTrue(cutomer_quote_monthly_rental);
	...
	public Object[][] getTestData() throws IOException {
		Object[][] data = ReadExcelData.getTestData("CP_BCH_fund_woMaint_LCV");
		return data;
	}
