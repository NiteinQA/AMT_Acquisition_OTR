...
public class Acquisition_Quotes_CP_PCP_LCV_with_funder_quote_addition_with_maintenance_Test extends TestBase {
	...
	@Test(priority = 4, dataProvider = "testData", dependsOnMethods = {
			"aquisition_quotes_CP_PCP_holding_cost_calculations_with_maintenance_test" })
	...
	public Object[][] getTestData() throws IOException {
		Object[][] data = ReadExcelData.getTestData("CP_PCP_funder_Maint_LCV");
		return data;
	}
