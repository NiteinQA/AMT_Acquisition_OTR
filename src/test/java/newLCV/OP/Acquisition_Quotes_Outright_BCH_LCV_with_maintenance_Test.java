...
public class Acquisition_Quotes_Outright_BCH_LCV_with_maintenance_Test extends TestBase {
	...
	@Test(priority = 2, dataProvider = "testData", dependsOnMethods = {
			"aquisition_quotes_outright_BCH_OTR_calculation_with_maintenance_test" })
	...
	@Test(priority = 3, dataProvider = "testData", dependsOnMethods = {
			"aquisition_quotes_outright_BCH_after_discount_calculations_with_maintenance_test" })

	public void aquisition_quotes_outright_BCH_other_support_check_with_maintenance_test(String manufacturer, String model,
			String road_tax_for_first_year, String on_road_price_for_invoice, String other_support_value ,String percentage_cap_residual_value_used,
			String percentage_cap_maintenance_cost_used, String residual_value_used, String main_cost_used,
			String actual_part_exchange_value_from_excel, String given_part_exchange_value_from_excel,
			String less_finance_settlement_from_excel, String order_deposit_from_excel, String document_fee_from_excel,
	...
	@Test(priority = 4, dataProvider = "testData", dependsOnMethods = {
			"aquisition_quotes_outright_BCH_other_support_check_with_maintenance_test" })
	...
	@Test(priority = 5, dataProvider = "testData", dependsOnMethods = {
			"aquisition_quotes_outright_BCH_holding_cost_calculations_with_maintenance_test" })
	...
	public void aquisition_quotes_outright_BCH_customer_quote_payment_profile_calculations_with_maintenance_test(String manufacturer, String model,
		...
		boolean cust_quote_for_one_payment_boolean_status = obj_customer_quote_page
				.customer_Quote_outright_BCH_for_one_payment_option_with_maintenance_calculation(
...
//				.customer_Quote_outright_BCH_for_all_payment_option_with_maintenance_calculation(initial_payment,
//						sheet_name);
...
//		Assert.assertTrue(quote_summary_configuration_value_check1);
	...
	public Object[][] getTestData() throws IOException {
		Object[][] data = ReadExcelData.getTestData("OutrightBCHwithMaint_LCV");
		return data;
	}
