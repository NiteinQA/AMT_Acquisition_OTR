...
public class Acquisition_Quotes_Outright_CP_LCV_without_maintenance_Test extends TestBase {
	...
	@Test(priority=5, dataProvider="testData", dependsOnMethods = { "aquisition_quotes_outright_CP_customer_quote_calculations_check_monthly_finance_payment_without_maintenance_test" })
	...
	@Test(priority=6, dataProvider="testData", dependsOnMethods = { "aquisition_quotes_outright_CP_customer_quote_vehicle_profit_edit_check_without_maintenance_test" })
...
//		// Assert.assertTrue(quote_summary_configuration_value_check1);
	...
	public Object[][] getTestData() throws IOException {
		Object[][] data = ReadExcelData.getTestData("OP_CPwoMaint_LCV");
		return data;
	}
