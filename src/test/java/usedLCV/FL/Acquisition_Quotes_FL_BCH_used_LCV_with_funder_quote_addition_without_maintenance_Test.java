...
public class Acquisition_Quotes_FL_BCH_used_LCV_with_funder_quote_addition_without_maintenance_Test extends TestBase {
...
//		Assert.assertTrue(balance_due_value1);
	...
	public Object[][] getTestData() throws IOException {
		Object[][] data = ReadExcelData.getTestData("FL_BCH_fund-wo-Maint_used_LCV");
		return data;
	}
