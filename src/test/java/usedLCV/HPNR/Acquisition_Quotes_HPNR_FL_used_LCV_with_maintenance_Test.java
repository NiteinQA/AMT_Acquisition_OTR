...
public class Acquisition_Quotes_HPNR_FL_used_LCV_with_maintenance_Test extends TestBase {
	...
	public void aquisition_quotes_used_LCV_OTR_calculation_with_maintenance_test(String registrationNumber,
	...
	@Test(priority = 2, dataProvider = "testData" , dependsOnMethods = {
			"aquisition_quotes_used_LCV_OTR_calculation_with_maintenance_test" })
	public void aquisition_quotes_used_LCV_edit_cost_price_and_check_OTR_with_maintenance_test(String registrationNumber,
			String mileage, String vehicelCostPrice, String options_and_preparation_cost, String percentage_cap_residual_value_used,
			String percentage_cap_maintenance_cost_used, String residual_value_used, String main_cost_used,
			String actual_part_exchange_value_from_excel, String given_part_exchange_value_from_excel,
			String less_finance_settlement_from_excel, String order_deposit_from_excel, String document_fee_from_excel,
...
//		Assert.assertTrue(cost_price_ex_vat_and_options_and_preparation_cost);
	...
	public void aquisition_quotes_used_LCV_holding_cost_calculations_with_maintenance_test(String registrationNumber,
			String mileage, String vehicelCostPrice, String options_and_preparation_cost, String percentage_cap_residual_value_used,
			String percentage_cap_maintenance_cost_used, String residual_value_used, String main_cost_used,
			String actual_part_exchange_value_from_excel, String given_part_exchange_value_from_excel,
			String less_finance_settlement_from_excel, String order_deposit_from_excel, String document_fee_from_excel,
	...
	@Test(priority = 4, dataProvider = "testData", dependsOnMethods = {
			"aquisition_quotes_used_LCV_holding_cost_calculations_with_maintenance_test" })

	public void aquisition_quotes_customer_quote_payment_profile_calculations_with_maintenance_test(String registrationNumber,
			String mileage, String vehicelCostPrice, String options_and_preparation_cost, String percentage_cap_residual_value_used,
			String percentage_cap_maintenance_cost_used, String residual_value_used, String main_cost_used,
			String actual_part_exchange_value_from_excel, String given_part_exchange_value_from_excel,
			String less_finance_settlement_from_excel, String order_deposit_from_excel, String document_fee_from_excel,
...
//		Assert.assertTrue(balance_due_value1);
	...
	public Object[][] getTestData() throws IOException {
		Object[][] data = ReadExcelData.getTestData("HPNR_FL_withMaint_used_LCV");
		return data;
	}
