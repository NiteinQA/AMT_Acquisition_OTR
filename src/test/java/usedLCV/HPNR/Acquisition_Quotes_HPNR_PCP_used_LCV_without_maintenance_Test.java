...
public class Acquisition_Quotes_HPNR_PCP_used_LCV_without_maintenance_Test extends TestBase {
...
//		Assert.assertTrue(holding_cost_after_editing_additional_terms_and_mileage);
	...
	public Object[][] getTestData() throws IOException {
		Object[][] data = ReadExcelData.getTestData("HPNR_PCP_w-oMaint_used_LCV");
		return data;
	}
