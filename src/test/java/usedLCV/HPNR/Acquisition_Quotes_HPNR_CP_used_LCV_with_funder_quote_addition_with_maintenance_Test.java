...
public class Acquisition_Quotes_HPNR_CP_used_LCV_with_funder_quote_addition_with_maintenance_Test extends TestBase {
...
//Assert.assertTrue(cost_price_ex_vat_and_options_and_preparation_cost);
	...
	public void aquisition_quotes_customer_quote_calculations_check_monthly_finance_payment_with_maintenance_test(String registrationNumber, String mileage,
		...
		boolean monthly_finance_payment_check = obj_customer_quote_page
				.check_monthly_finance_payment_on_customer_quote_for_used_car_with_funder_quote_addition_with_maintenance(
	...
	public Object[][] getTestData() throws IOException {
		Object[][] data = ReadExcelData.getTestData("HPNR_CP_fund_Maint_used_LCV");
		return data;
	}
