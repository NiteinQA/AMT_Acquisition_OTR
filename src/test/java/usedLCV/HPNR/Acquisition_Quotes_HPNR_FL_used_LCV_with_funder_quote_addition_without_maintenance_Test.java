...
public class Acquisition_Quotes_HPNR_FL_used_LCV_with_funder_quote_addition_without_maintenance_Test extends TestBase {
	...
	@Test(priority=2, dataProvider="testData", dependsOnMethods = { "aquisition_quotes_used_LCV_OTR_calculation_with_maintenance_test" })
...
//Assert.assertTrue(cost_price_ex_vat_and_options_and_preparation_cost);
	...
	@Test(priority=3, dataProvider="testData", dependsOnMethods = { "aquisition_quotes_used_LCV_edit_cost_price_and_check_OTR_with_maintenance_test" })
	...
	public void aquisition_quotes_customer_quote_payment_profile_calculations_without_maintenance_test(String registrationNumber, String mileage, String vehicelCostPrice, String options_and_preparation_cost,
		...
		boolean cutomer_quote_monthly_rental = obj_customer_quote_page
				.customer_Quote_HPNR_FL_for_all_payment_option_for_funder_quote_addition_without_maintenance_calculation(initial_payment,sheet_name);
...
//		Assert.assertTrue(balance_due_value1);
	...
	public Object[][] getTestData() throws IOException {
		Object[][] data = ReadExcelData.getTestData("HPNR_FL_fund-wo-Maint_used_LCV");
		return data;
	}
