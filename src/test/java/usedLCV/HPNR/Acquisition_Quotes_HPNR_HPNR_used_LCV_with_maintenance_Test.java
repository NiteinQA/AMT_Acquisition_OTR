...
public class Acquisition_Quotes_HPNR_HPNR_used_LCV_with_maintenance_Test extends TestBase {
...
//		Assert.assertTrue(holding_cost_after_editing_additional_terms_and_mileage);
	...
	public Object[][] getTestData() throws IOException {
		Object[][] data = ReadExcelData.getTestData("HPNR_HPNR_Maint_used_LCV");
		return data;
	}
