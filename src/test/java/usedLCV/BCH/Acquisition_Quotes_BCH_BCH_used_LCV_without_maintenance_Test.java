...
public class Acquisition_Quotes_BCH_BCH_used_LCV_without_maintenance_Test extends TestBase {
	...
	@Test(priority=2, dataProvider="testData", dependsOnMethods = { "aquisition_quotes_OTR_calculation_without_maintenance_test" })
	...
	public void aquisition_quotes_customer_quote_payment_profile_calculations_without_maintenance_test(String registrationNumber,
			String mileage, String vehicelCostPrice, String options_and_preparation_cost,
			String quoteReference, String quoteExpiryDate,String terms,String milesPerAnnum, String monthlyFinanceRental, String documentFee, 
			String penceperExcessMileFinance, String actual_part_exchange_value_from_excel, String given_part_exchange_value_from_excel,
			String less_finance_settlement_from_excel, String order_deposit_from_excel, String document_fee_from_excel,
		...
		boolean customer_quote_for_payment_boolean = obj_customer_quote_page
				.customer_Quote_BCH_PCH_for_one_payment_option_without_maintenance_calculation(
...
//		LO.print("****************************************************************");
	...
	public Object[][] getTestData() throws IOException {
		Object[][] data = ReadExcelData.getTestData("BCH_BCH_w-o-Maint_used_LCV");
		return data;
	}
