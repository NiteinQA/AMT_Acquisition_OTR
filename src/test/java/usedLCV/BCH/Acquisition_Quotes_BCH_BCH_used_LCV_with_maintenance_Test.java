...
public class Acquisition_Quotes_BCH_BCH_used_LCV_with_maintenance_Test extends TestBase {
	...
	public void aquisition_quotes_OTR_calculation_with_maintenance_test(String registrationNumber,
		...
		System.out.println("**********Assertion Passed For OTR Price Check**********");
		System.out.println("****************************************************************");

		LO.print("**********Assertion Passed For OTR Price Check**********");
		LO.print("****************************************************************");


	}
	
	@Test(priority=2, dataProvider="testData", dependsOnMethods = { "aquisition_quotes_OTR_calculation_with_maintenance_test" })
	...
	@Test(priority=3, dataProvider="testData", dependsOnMethods = { "aquisition_quotes_holding_cost_calculations_with_maintenance_test" })
	...
	public void aquisition_quotes_customer_quote_payment_profile_calculations_with_maintenance_test(String registrationNumber,
			...
			String less_finance_settlement_from_excel, String order_deposit_from_excel, String document_fee_from_excel,
			String security_deposit, String matrix_upsell, String referrer_upsell, String add_terms, String add_mileage, String maintenance_required, String maintenance_margin, String initial_payment,
			String part_exchange_status, String target_rental, String sheet_name) throws InterruptedException, IOException, UnsupportedFlavorException, FormulaParseException, IllegalStateException, ClassNotFoundException {
...
//		LO.print("****************************************************************");
	...
	@Test(priority=4, dataProvider="testData", dependsOnMethods = { "aquisition_quotes_customer_quote_payment_profile_calculations_with_maintenance_test" })
	...
	public Object[][] getTestData() throws IOException {
		Object[][] data = ReadExcelData.getTestData("BCH_BCH_withMaint_used_LCV");
		return data;
	}
