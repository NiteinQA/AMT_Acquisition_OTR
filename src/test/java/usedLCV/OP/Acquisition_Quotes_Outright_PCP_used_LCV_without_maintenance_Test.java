...
public class Acquisition_Quotes_Outright_PCP_used_LCV_without_maintenance_Test extends TestBase {
    ...
    @Test(priority = 6, dataProvider = "testData", dependsOnMethods = {"aquisition_quotes_customer_quote_part_exchange_value_edit_check_without_maintenance_test"})
	...
	public Object[][] getTestData() throws IOException {
		Object[][] data = ReadExcelData.getTestData("OP_PCP_w-oMaint_used_LCV");
		return data;
	}
