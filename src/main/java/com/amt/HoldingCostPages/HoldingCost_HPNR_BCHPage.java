...
public class HoldingCost_HPNR_BCHPage extends TestBase {
...
//	private WebElement holding_cost_summary_residual_value_used;
	...
	public boolean verify_holding_cost_after_adding_funder_quote_without_maintenance(String quoteRef, String expiryDate,
		...
		double monthly_holding_cost_expected = obj_read_excel_calculation_page
				.verify_holding_cost_after_adding_funder_without_maintenance_for_hpnr_bch_pch(term, milesPerAnnum,
						monthlyPayment, finalBalloonPayment, documentFee, sheet_name);
	...
	public boolean verify_holding_cost_after_adding_funder_quote_with_maintenance(String quoteRef, String expiryDate,
		...
		obj_read_excel_calculation_page = new ReadExcelCalculation();
		double monthly_holding_cost_expected = obj_read_excel_calculation_page
				.verify_holding_cost_after_adding_funder_with_maintenance_for_hpnr_bch_pch(term, milesPerAnnum,
						monthlyPayment, cap_monthly_maint_value_from_screen, finalBalloonPayment, documentFee,
						sheet_name);
