...
public class HoldingCost_HPNR_HPNRPage extends TestBase {
	...
	public boolean verify_holding_cost_after_adding_funder_quote_with_maintenance(String quoteRef, String expiryDate,
		...
		obj_read_excel_calculation_page = new ReadExcelCalculationForPurchaseAgreement();
		double monthly_holding_cost_expected = obj_read_excel_calculation_page
				.verify_holding_cost_after_adding_funder_with_maintenance_for_hpnr_hire_purchase(totalCashPrice,
						cashDeposit, term, milesPerAnnum, monthlyPayment, totalCapMaintenanceValue, finalBalloonPayment,
						documentFee, sheet_name);
