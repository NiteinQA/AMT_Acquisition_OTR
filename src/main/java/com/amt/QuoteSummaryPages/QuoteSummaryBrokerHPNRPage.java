...
public class QuoteSummaryBrokerHPNRPage extends TestBase {
	...
	@FindBy(xpath = "//*[normalize-space()='Contract type']//ancestor::div[1]//div//p//strong")
	...
	public boolean quote_summary_broker_HPNR(String sheet_name) throws InterruptedException, IOException {
	...
	public boolean quote_summary_broker_purchase_used_vehicle(String sheet_name)
		...
		return obj_read_excel_calculation_page
				.verify_quote_summary_values_for_broker_purchase_from_excel_for_used_vehicle(
						quote_summary_cost_otr_price_from_screen_converted, sheet_name);
