...
public class CustomerQuotePageBrokerFLPage extends TestBase {
	...
	@FindBy(xpath = "//input[@id='percentageOfSaleProceedsToCustomer']")
	private WebElement percentageOfSaleProceedstoCustomer;

	@FindBy(xpath = "//input[@id='secondaryHirePeriodRental']")
	private WebElement secondaryHirePeriodrental;
	...
	public boolean customer_Quote_broker_fl_with_maintenance(String quoteRef, String quoteExpiryDate, String term,
			String milesperannum, String initialFinanceRental, String initialMaintenanceRental,
			String monthlyFinanceRental, String monthlyMaintenanceRental, String finalBallonPayment,
			String pensePerExcessMileFinance, String pensePerExcessMileMaintenance,
			String percentageOfSaleProceedsOfCustomer, String secondaryHirePeriodRental, String commission2)
		...
		for (int i = 1; i <= 1; i++) {
			...
			Click.sendKeys(driver, percentageOfSaleProceedsToCustomer, percentageOfSaleProceedsOfCustomer, 60);

			Click.sendKeys(driver, secondaryHirePeriodrental, secondaryHirePeriodRental, 60);
...
//		ExplicitWait.waitTillLoadingIconDisappears(driver, loading_icon, 200);
	...
	public boolean customer_Quote_broker_fl_without_maintenance(String quoteRef, String quoteExpiryDate, String term,
			String milesperannum, String initialFinanceRental, String monthlyFinanceRental, String finalBallonPayment,
			String pensePerExcessMileFinance, String percentageOfSaleProceedsToCustomer,
			String secondaryHirePeriodRental, String commission2) throws InterruptedException {
		...
		for (int i = 1; i <= 1; i++) {
			...
			Click.sendKeys(driver, finalBalloonPayment, finalBallonPayment, 30);

			Click.sendKeys(driver, pence_Per_ExcessMileage_Finance, pensePerExcessMileFinance, 60);

			Click.sendKeys(driver, percentageOfSaleProceedstoCustomer, percentageOfSaleProceedsToCustomer, 60);
