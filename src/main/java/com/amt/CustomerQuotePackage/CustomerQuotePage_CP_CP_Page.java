...
public class CustomerQuotePage_CP_CP_Page extends TestBase {

	CustomerQuotePage_CP_CP_Page obj_cust_quote_outright_bchPage;
	...
	public CustomerQuotePage_CP_CP_Page() {
	...
	public boolean check_monthly_finance_payment_on_customer_quote_for_used_car_with_funder_quote_addition_with_maintenance(
		...
		if (totalCapMaintenanceValue == 0) {
			...
			try {
			Click.on(driver, customer_quote_maintenance_toggle_button, 20);
			}catch (Exception e)
			{
				Click.on(driver, customer_quote_maintenance_toggle_button, 20);
			}
