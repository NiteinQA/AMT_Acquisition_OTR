	...
	public boolean check_monthly_finance_payment_on_customer_quote_with_funder_quote_addition(WebDriver driver,
		...
		try {
			List<WebElement> list = driver.findElements(
					By.xpath("//*[@class='ng-dropdown-panel ng-star-inserted ng-select-bottom']/div/div/div"));
		...
		ExplicitWait.visibleElement(driver, customer_quote_monthly_finance_rental, 20);
