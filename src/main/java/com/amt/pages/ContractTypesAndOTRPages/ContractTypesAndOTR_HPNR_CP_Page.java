...
public class ContractTypesAndOTR_HPNR_CP_Page extends TestBase {
	ContractTypesAndOTR_HPNR_CP_Page obj_contract_types_outright_bch_ownbook_calculation_page;
	...
	public ContractTypesAndOTR_HPNR_CP_Page() {
