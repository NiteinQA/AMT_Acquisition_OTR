...
public class ContractTypesAndOTR_Broker_BCH_Page extends TestBase {
...
//	private WebElement acq_contractTypes_OTR_price;
	@FindBy(xpath = "//div[@id='customerContractType.contractTypeId']//p[@class='text-center'][normalize-space()='Business Contract Hire']")
	...
	//*[@id="Rule_Modal"]/div/div/div[3]/div/input

	public ContractTypesAndOTR_Broker_BCH_Page() {
	...
	public boolean contractTypes_selection_and_OTR_calculation(String sheet_name)
		...
		try {
			...
			Thread.sleep(2000);
			Click.on(driver, acq_contractTypes_customer_contract_BCH, 10);
			Thread.sleep(2000);
...
//		System.out.println("RFL AND FRF from screen is " + rfl_and_frf);
	...
	public boolean contractTypes_and_OTR_selection_broker_bch(String sheet_name)
			throws InterruptedException, IOException, UnsupportedFlavorException {
...
//	   act.sendKeys(Keys.TAB,Keys.TAB,Keys.TAB,Keys.TAB,Keys.TAB,Keys.ENTER).build().perform();
		...
		LO.print("Customer Contract type option selected = Business Contract Hire(BCH)");
		System.out.println("Customer Contract type option selected = Business Contract Hire(BCH)");
	...
	public boolean contractTypes_and_OTR_selection_broker_bch_vehicle_price_edited(String vehicleBasicPrice,
