...
public class ContractTypesAndOTR_HPNR_PCH_Page extends TestBase {
	ContractTypesAndOTR_HPNR_PCH_Page obj_contract_types_outright_bch_ownbook_calculation_page;
	...
	public ContractTypesAndOTR_HPNR_PCH_Page() {
...
//		System.out.println("RFL AND FRF from screen is " + rfl_and_frf);
	...
	public boolean contractTypes_and_OTR_selection_HPNR_PCH_Ownbook_calculation(String sheet_name)
			throws InterruptedException, IOException, UnsupportedFlavorException {
		Click.on(driver, acq_contractTypes, 50);
		ExplicitWait.waitTillLoadingIconDisappears(driver, loading_icon, 200);
		Click.on(driver, acq_acq_contractTypes_HPNR, 50);
