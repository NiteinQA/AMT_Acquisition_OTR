...
public class ContractTypesAndOTR_Broker_PCH_Page extends TestBase {
	...
	public ContractTypesAndOTR_Broker_PCH_Page() {
...
//		System.out.println("RFL AND FRF from screen is " + rfl_and_frf);
	...
	public boolean contractTypes_and_OTR_selection_broker_pch(String sheet_name)
			throws InterruptedException, IOException, UnsupportedFlavorException {
...
//	   act.sendKeys(Keys.TAB,Keys.TAB,Keys.TAB,Keys.TAB,Keys.TAB,Keys.ENTER).build().perform();
	...
	public boolean contractTypes_and_OTR_selection_broker_pch_vehicle_price_edited(String vehicleBasicPrice,
