...
public class ContractTypesAndOTR_OP_OP_Page extends TestBase {
	ContractTypesAndOTR_OP_OP_Page obj_contract_types_outright_bch_ownbook_calculation_page;
	...
	@FindBy(xpath = "(//p[contains(text(),'Outright Purchase')])[2]")
	private WebElement acq_contractTypes_outright_purchase;
	...
	public ContractTypesAndOTR_OP_OP_Page() {
	...
	public boolean contractTypes_selection_and_OTR_calculation(String sheet_name)
		...
		Click.on(driver, acq_contractTypes_outright_purchase, 30);

		LO.print(" Customer Contract type option = Outright Purchase has been selected");
		System.out.println(" Customer Contract type option = Outright Purchase has been selected");
		ExplicitWait.waitTillLoadingIconDisappears(driver, loading_icon, 200);
...
//		System.out.println("RFL AND FRF from screen is " + rfl_and_frf);
	...
	public boolean contractTypes_and_OTR_selection_OP_OP_Ownbook_calculation(String sheet_name)
			throws InterruptedException, IOException, UnsupportedFlavorException {
		Click.on(driver, acq_contractTypes, 50);
		ExplicitWait.waitTillLoadingIconDisappears(driver, loading_icon, 200);
		Click.on(driver, acq_acq_contractTypes_outright, 50);
