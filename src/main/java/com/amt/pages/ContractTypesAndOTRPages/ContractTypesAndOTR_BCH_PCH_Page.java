...
public class ContractTypesAndOTR_BCH_PCH_Page extends TestBase {
	...
	public ContractTypesAndOTR_BCH_PCH_Page() {
...
//		System.out.println("RFL AND FRF from screen is " + rfl_and_frf);
	...
	public boolean contractTypes_and_OTR_selection_BCH_PCH_vehicle_price_edited(String vehicleBasicPrice,
