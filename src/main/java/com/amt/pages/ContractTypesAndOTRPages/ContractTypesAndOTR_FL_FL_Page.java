...
public class ContractTypesAndOTR_FL_FL_Page extends TestBase {
	ContractTypesAndOTR_FL_FL_Page obj_contract_types_outright_bch_ownbook_calculation_page;
	...
	@FindBy(xpath = "(//p[contains(text(),'Finance Lease')])[2]")
	...
	public ContractTypesAndOTR_FL_FL_Page() {
