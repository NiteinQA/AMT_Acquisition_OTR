...
public class ContractTypesAndOTR_Outright_CP_Page extends TestBase {
	ContractTypesAndOTR_Outright_CP_Page obj_contract_types_outright_bch_ownbook_calculation_page;
...
//		System.out.println("RFL AND FRF from screen is " + rfl_and_frf);
	...
	public boolean contractTypes_and_OTR_selection_outright_CP_Ownbook_calculation(String sheet_name)
			throws InterruptedException, IOException, UnsupportedFlavorException {
		Click.on(driver, acq_contractTypes, 50);
		ExplicitWait.waitTillLoadingIconDisappears(driver, loading_icon, 30);
		Click.on(driver, acq_acq_contractTypes_outright, 50);
