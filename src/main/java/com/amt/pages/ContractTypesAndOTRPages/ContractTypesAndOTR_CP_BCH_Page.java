...
public class ContractTypesAndOTR_CP_BCH_Page extends TestBase {
	ContractTypesAndOTR_CP_BCH_Page obj_contract_types_outright_bch_ownbook_calculation_page;
	...
	public ContractTypesAndOTR_CP_BCH_Page() {
...
//		System.out.println("RFL AND FRF from screen is " + rfl_and_frf);
	...
	public boolean contractTypes_and_OTR_selection_CP_BCH_Ownbook_calculation_cp_hire_funder_addition(String sheet_name)
		...
		double subtotal_after_discount_excel = obj_read_excel_calculation_page
				.verify_table_calculations_contract_types_page_cp_hire(driver, vehicle_price_copied,
	...
	public boolean verify_after_discount_calculations_contract_types_page_cp_hire_funder_addition(String sheet_name)
			throws IOException {
