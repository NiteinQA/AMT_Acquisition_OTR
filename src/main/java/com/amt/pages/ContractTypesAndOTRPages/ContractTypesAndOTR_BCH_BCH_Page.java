...
public class ContractTypesAndOTR_BCH_BCH_Page extends TestBase {
	ContractTypesAndOTR_BCH_BCH_Page obj_contract_types_BCH_bch_ownbook_calculation_page;
	...
	@FindBy(xpath = "(//p[contains(text(),'Business Contract Hire')])[1]")
	private WebElement acq_acq_contractTypes_BCH;
	...
	public ContractTypesAndOTR_BCH_BCH_Page() {
...
//		System.out.println("RFL AND FRF from screen is " + rfl_and_frf);
	...
	public boolean contractTypes_and_OTR_selection_BCH_BCH_Ownbook_calculation(String sheet_name)
			throws InterruptedException, IOException, UnsupportedFlavorException {
		Click.on(driver, acq_contractTypes, 50);
		ExplicitWait.waitTillLoadingIconDisappears(driver, loading_icon, 200);
		Click.on(driver, acq_acq_contractTypes_BCH, 50);
	...
	public boolean contractTypes_and_OTR_selection_BCH_bch_vehicle_price_edited(String vehicleBasicPrice,
