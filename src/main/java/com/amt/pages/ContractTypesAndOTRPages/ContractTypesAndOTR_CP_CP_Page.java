...
public class ContractTypesAndOTR_CP_CP_Page extends TestBase {
	...
	public ContractTypesAndOTR_CP_CP_Page() {
	...
	public boolean contractTypes_selection_and_OTR_calculation(String sheet_name)
		...
		LO.print(" Customer Contract type option = CP has been selected");
		System.out.println(" Customer Contract type option = CP has been selected");
		ExplicitWait.waitTillLoadingIconDisappears(driver, loading_icon, 200);
