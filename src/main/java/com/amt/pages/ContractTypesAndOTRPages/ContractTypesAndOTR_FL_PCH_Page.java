...
public class ContractTypesAndOTR_FL_PCH_Page extends TestBase {
	ContractTypesAndOTR_FL_PCH_Page obj_contract_types_outright_bch_ownbook_calculation_page;
	...
	public ContractTypesAndOTR_FL_PCH_Page() {
...
//		System.out.println("RFL AND FRF from screen is " + rfl_and_frf);
	...
	public boolean contractTypes_and_OTR_selection_FL_PCH_OTR_calculations(String sheet_name)
			throws InterruptedException, IOException, UnsupportedFlavorException {
		Click.on(driver, acq_contractTypes, 50);
		ExplicitWait.waitTillLoadingIconDisappears(driver, loading_icon, 200);
		Click.on(driver, acq_acq_contractTypes_FL, 50);
